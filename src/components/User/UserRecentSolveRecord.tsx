...
function UserRecentSolveRecord(
            ...
            <List sx={globalStyles.component.list.listParent}>
                ...
                {statusMessage == null && <div>
                    ...
                    {records.map((record:any) => (<div>
                        <ListItem sx={globalStyles.component.list.listItem.flexRowCenter}>
                            <Container maxWidth={false} disableGutters sx={styles.titleTextStyle}>
                                <Button variant="text" onClick={() => {navigate(`/problemsolve/${record.problemRecord.problemEntry.titleSlug}`)}}>
                                    <Typography variant='body1'>{record.problemRecord.problemEntry.frontendID}. {record.problemRecord.problemEntry.title}</Typography>
                                </Button>
                            </Container>
...
export default UserRecentSolveRecord;
